...
class WellnessServiceCategoryDetailsScreen extends StatelessWidget {
  final WellnessServiceCategory category;

  const WellnessServiceCategoryDetailsScreen(
      {super.key, required this.category});

  @override
  Widget build(BuildContext context) {
    return MasterScreen(
      title: 'Wellness Service Category Details',
      showBackButton: true,
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Text(
                      'Wellness Service Category Information',
                      style: TextStyle(
                        fontSize: 24,
                ...
                // Category image/icon and basic info
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
          ...
          children: [
            ...
            Expanded(
              child: _buildInfoItem(
                ...
                iconColor: category.isActive ? Colors.green : Colors.red,
              ),
            ),
          ],
        ),
