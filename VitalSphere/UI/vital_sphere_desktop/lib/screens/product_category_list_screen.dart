...
import 'package:vital_sphere_desktop/screens/product_category_details_screen.dart';
import 'package:vital_sphere_desktop/screens/product_category_edit_screen.dart';
...
class _ProductCategoryListScreenState extends State<ProductCategoryListScreen> {
  ...
  SearchResult<ProductCategory>? productCategories;
  int _currentPage = 0;
  int _pageSize = 5;
  ...
  Future<void> _performSearch({int? page, int? pageSize}) async {
    ...
    var categories = await productCategoryProvider.get(filter: filter);
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      productCategoryProvider = context.read<ProductCategoryProvider>();
